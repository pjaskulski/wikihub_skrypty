""" uzupełnienie danych PRNG/SIMC miejscowosci z pliku miejscowosciU_QID.xlsx"""
import os
import sys
import time
        ...
        if WIKIBASE_WRITE:
            ...
            while True:
                try:
                    ...
                    print(f"{index}/{max_row - 1} Uzupełniono właściwości PRNG i SIMC")
                    break
            ...
            print(f"{index}/{max_row - 1} Przygotowano uzupełnienie właściwości PRNG i SIMC.")
