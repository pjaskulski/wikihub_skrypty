""" Uzupełnianie danych miejscowosci z pliku miejscowosciP.xlsx (dane z PRNG, pozostałe)
o QID z wikibase
"""
import openpyxl
...
if __name__ == '__main__':
    ...
    xlsx_output = '../data_prng/miejscowosciP_QID.xlsx'
    qid_input = '../data_prng/miejscowosciP_qid.txt'
