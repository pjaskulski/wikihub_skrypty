""" skrypt dodaje nową wartość do istniejącej deklaracji (statement) w elemencie Q """
...
if __name__ == "__main__":
    ...
    moje_dane = wbi_datatype.String(value='Kettler-The Older II', prop_nr='P4', if_exists='APPEND')
    data = [moje_dane]
