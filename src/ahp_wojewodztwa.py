""" import województw z AHP (XVI wiek) """
...
if __name__ == '__main__':
    ...
    file_name = Path('..') / 'data' / 'ahp_wojewodztwa.csv'
    ...
    for line in lines:
        ...
        if not ok:
            ...
            print(f'Element: # [https://prunus-208.man.poznan.pl/wiki/Item:{new_id} {label_en} / {label_pl}] już istnieje')
