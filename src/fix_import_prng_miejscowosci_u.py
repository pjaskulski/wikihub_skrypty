...
if __name__ == '__main__':
    ...
    index_to_fix = [22266, 33663, 52160, 77547, 80262, 80507, 80548, 81122, 81232,
                    82578, 82579, 82615, 82832, 83686, 84651, 85666, 86498, 86586,
                    86626, 87073, 88081, 90311, 91016, 91845, 93762, 94403, 94502,
                    94680, 94701, 95302]
